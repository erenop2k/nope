        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    f"Darlingg!! Ooof Finally Found You Welcome to {html.escape(chat.title)} [❤️](https://telegra.ph/file/9b074efdec3ff1bad6300.jpg).", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            if new_mem.id in DRAGONS:
                update.effective_message.reply_text(
                    "Huh! My Sensei just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in DEMONS:
                update.effective_message.reply_text(
                    "Huh! My Best-Friend just joined!",
                    reply_to_message_id=reply,
                )
                continue
